...
BEGIN
  ...
  -- validate_transition exige que las cotizaciones nazcan en draft/sent.
  -- Sembramos en draft y transicionamos a accepted (transición permitida).
  ...
  -- Pivote invoice_bookings: el detalle de factura lee sourceBookings desde aquí,
  -- no desde invoices.booking_id (legacy). Sin este insert, la prueba E2E
  -- "invoice detail shows source booking link" no encuentra el badge.
