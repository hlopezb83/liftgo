-- Permite que la reconciliación financiera canónica degrade una factura histórica
-- pagada a sent/partial/overdue cuando desaparece su cobertura. El helper
-- sync_invoice_status activa app.payment_sync de forma local y SECURITY DEFINER.
