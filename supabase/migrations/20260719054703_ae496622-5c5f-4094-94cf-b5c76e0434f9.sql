...
-- ============================================================
-- BL-17: relajar constraint no_overlapping_bookings
-- ============================================================
...
-- ============================================================
-- BL-18 + BL-19: reescribir get_income_statement con depreciación
-- prorrateada y expenses por fecha de pago en base cash
-- ============================================================
...
BEGIN
  ...
  -- Mantenimiento y daños: no existe fecha de pago separada. En base cash
  -- se usa la fecha del evento (performed_at / created_at) como aproximación.
  maint_by_month AS (
    SELECT
  ...
  -- BL-19: en base cash, los gastos de proveedor se prorratean por pagos
  -- reales (fecha y monto) contra el subtotal de la factura. En accrual se
  -- usa el subtotal completo a fecha de emisión.
  ...
  -- BL-18: días rentados por forklift × mes (intersección del rango).
  ...
  -- BL-18: months_rented para venta también prorratea por días efectivos.
