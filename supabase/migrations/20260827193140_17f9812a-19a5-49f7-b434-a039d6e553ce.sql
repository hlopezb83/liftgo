...
BEGIN
  ...
  SELECT json_build_object(
      ...
      FROM (
        SELECT
          ...
          COALESCE((
            ...
            -- la vista de atribucion; antes solo miraba invoices.booking_id.
    ...
    'cash_flow', (
      ...
      paid_cte AS (
        -- FIX: no perder pagos historicos sin amount_mxn (columna agregada
        -- despues). Precedencia FX: pago -> factura -> 1:1 solo si es MXN.
        -- FIX A6: incluye facturas legadas en 'paid' sin renglon en payments.
