-- F5 (Sprint M1): el camino legacy del frontend enviaba daily/weekly/monthly
-- en 0 y este UPDATE pisaba con ceros las tarifas de la reserva. Un 0 no cae
-- al catálogo en los previews. Ahora una tarifa entrante en 0 (o nula)
-- conserva la tarifa existente vía COALESCE(NULLIF(rate, 0), tarifa_actual).
