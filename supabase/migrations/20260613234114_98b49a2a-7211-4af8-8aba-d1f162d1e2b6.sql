...
BEGIN
  ...
  -- Borra pagos del scope (marcados is_e2e) Y también pagos creados por flujos
  -- reales de la app que referencian facturas sembradas (la factura ya prueba
  -- el scope; el pago no lleva bandera porque useCreatePayment no la pone).
