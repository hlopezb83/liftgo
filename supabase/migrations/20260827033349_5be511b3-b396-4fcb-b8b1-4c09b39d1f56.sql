-- R5-06: el seed E2E solo borraba invoices/bookings/quotes marcados como E2E,
-- pero los DELETE de customer_payment_intents y payments apuntaban a TODAS las
-- invoices del cliente (incluidas las reales). Se acota el subselect a is_e2e = true.
