-- FIX R5-04: validate_transition no permitia invoices 'partial' -> 'paid',
-- dejando atascadas facturas con abonos que se liquidan por fuera del
-- flujo de sync de pagos. Se agrega 'paid' a las transiciones validas
-- desde 'partial'. NO se agrega 'sent': una factura parcialmente pagada
-- ya entro al ciclo de cobro y retrocederla a 'sent' falsearia el aging
-- y la conciliacion de pagos.
