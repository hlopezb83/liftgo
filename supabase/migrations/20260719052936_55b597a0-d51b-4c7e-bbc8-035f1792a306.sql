...
BEGIN
  ...
  -- BL-09: Notas de crédito. Reducen ingresos por el subtotal (sin IVA) del mes
  -- en el que se emiten (o pagan si es base cash). Se clasifican como renta o
  -- venta heredando la clasificacion de la factura padre. Excluimos NCs
  -- canceladas y las de proyectos e2e para no ensuciar KPIs.
  cn_base AS (
    SELECT
      cn.id,
      cn.subtotal,
