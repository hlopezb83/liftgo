...
INSERT INTO public.invoices (id, invoice_number, customer_id, customer_name, subtotal, tax_amount, total, status, line_items) VALUES
  ('22222222-0000-4000-8000-0000000000a2', 'FAC-RLS-A', '22222222-0000-4000-8000-0000000000a1', 'Cliente A RLS', 1000, 0, 1000, 'sent',
   '[{"description":"Renta RLS A","quantity":1,"unit_price":1000,"amount":1000}]'::jsonb),
  ('22222222-0000-4000-8000-0000000000b2', 'FAC-RLS-B', '22222222-0000-4000-8000-0000000000b1', 'Cliente B RLS', 900, 0, 900, 'sent',
   '[{"description":"Renta RLS B","quantity":1,"unit_price":900,"amount":900}]'::jsonb);
