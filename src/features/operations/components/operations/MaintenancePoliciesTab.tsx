...
export function MaintenancePoliciesTab() {
  ...
  const columns: ColumnDef<MaintenancePolicy>[] = [
    ...
    { id: "monthly_cost", header: "Costo Mensual", accessorKey: "monthly_cost", meta: { kind: "money" }, cell: ({ row }) => <span className="font-mono">{formatCurrency(row.original.monthly_cost)}</span> },
