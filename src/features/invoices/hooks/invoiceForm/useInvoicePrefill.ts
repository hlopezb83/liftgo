...
type Assignment = { line_index: number; forklift_id: string };
...
function buildFromInvoice(inv: ExistingInvoice, customers: Customer[] | undefined): InvoiceFormValues {
...
function buildFromQuote({ q, assignments, forklifts, customers }: FromQuoteArgs): InvoiceFormValues {
