...
const FIELD_LABELS: Record<string, string> = {
  ...
  issued_at: "Fecha de Emisión", scheduled_date: "Fecha Programada", scheduled_time: "Hora Programada", performed_at: "Fecha de Realización",
  ...
  equipment_model_id: "Modelo de Equipo",
