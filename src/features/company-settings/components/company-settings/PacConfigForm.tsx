    ...
    <div className="space-y-1.5">
      ...
      <div className="relative">
        <Input
          ...
          placeholder={
            isConfigured ? "•••••••• (capturar para reemplazar)" : placeholder
          }
          className="pr-10"
          autoComplete="off"
        />
  ...
  return (
    <Card className="mt-6">
      ...
      <CardContent className="space-y-4">
        ...
        <p className="text-xs text-muted-foreground">
          Por seguridad, las llaves nunca se descargan al navegador. Solo se
          muestra si están configuradas; captura un valor para reemplazarlas.
        </p>
