...
describe("parseBankCsv — validación de columnas (R23-J)", () => {
  ...
  it("rechaza la fila con columnas de más", async () => {
  ...
  it("sigue importando filas bien formadas", async () => {
    const csv = [
