    ...
    <Card>
      ...
      <CardContent>
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 text-sm">
          <div><span className="text-muted-foreground block">Inicio</span>{formatDateMty(startDate)}</div>
          <div><span className="text-muted-foreground block">Fin</span>{formatDateMty(endDate)}</div>
