...
export function RatesCard({ control }: { control: Ctrl }) {
  return (
    <Card>
...
export function UsageConditionsCard({ control }: { control: Ctrl }) {
  return (
    <Card>
...
export function TermsAndSignaturesCard({ control }: { control: Ctrl }) {
  return (
    <Card>
