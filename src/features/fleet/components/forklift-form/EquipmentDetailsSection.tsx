...
// FIX-11: en alta solo 'available'. Si la unidad entra a taller, se crea
// disponible y luego se cambia de estado con razón (change_forklift_status/OT);
// darla de alta directamente en 'maintenance' dejaba la unidad sin razón ni OT.
const CREATABLE_FORKLIFT_STATUSES = ["available"] as const;
