...
import { SuccessIcon, DeleteIcon, EditIcon } from "@/components/icons";
...
export function DeliveryActions({ status, canDelete, onEdit, onComplete, onDelete }: DeliveryActionsProps) {
      ...
      <RoleGuard module="Entregas" minAccess="full" fallback={null}>
        {status === "scheduled" && (
          <Button variant="outline" size="sm" onClick={onEdit}>
            <EditIcon className="h-4 w-4 mr-1" /> Reprogramar
          </Button>
        )}
