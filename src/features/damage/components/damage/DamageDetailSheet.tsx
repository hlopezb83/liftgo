      ...
      <SheetContent className="sm:max-w-md overflow-y-auto">
        ...
        <div className="mt-4 space-y-4">
          ...
          <div className="space-y-1">
            ...
            {/* Un costo real de $0 en un daño ya reparado/facturado SÍ es
                información (garantía absorbida / sin costo); solo se oculta
                mientras el daño sigue abierto sin costo capturado. */}
            {record.actual_cost != null &&
              (record.actual_cost > 0 || record.status === "repaired" || record.status === "invoiced") && (
