...
export const appRoutes: RouteConfig[] = [
  ...
  { path: "/cuentas-por-pagar", component: CuentasPorPagarPage, module: "Facturas de Proveedor" },
  { path: "/cuentas-por-pagar/antiguedad", component: AgingReportPage, module: "Facturas de Proveedor" },
