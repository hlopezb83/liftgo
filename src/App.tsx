...
const routes: RouteConfig[] = [
  ...
  { path: "/invoices", component: InvoicesPage, roles: ["admin", "dispatcher", "administrativo"] },
  { path: "/invoices/new", component: InvoiceForm, roles: ["admin", "dispatcher", "administrativo"] },
  { path: "/invoices/:id", component: InvoiceDetail, roles: ["admin", "dispatcher", "administrativo"] },
  { path: "/invoices/:id/edit", component: InvoiceForm, roles: ["admin", "dispatcher", "administrativo"] },
  { path: "/returns", component: ReturnInspectionPage, roles: ["admin", "dispatcher", "administrativo"] },
  { path: "/deliveries", component: DeliveriesPage, roles: ["admin", "dispatcher", "administrativo"] },
  { path: "/quotes", component: QuotesPage, roles: ["admin", "dispatcher", "administrativo"] },
  { path: "/quotes/new", component: QuoteForm, roles: ["admin", "dispatcher", "administrativo"] },
  { path: "/quotes/:id", component: QuoteDetail, roles: ["admin", "dispatcher", "administrativo"] },
  { path: "/quotes/:id/edit", component: QuoteForm, roles: ["admin", "dispatcher", "administrativo"] },
  { path: "/contracts", component: ContractsPage, roles: ["admin", "dispatcher", "administrativo"] },
  { path: "/contracts/new", component: ContractForm, roles: ["admin", "dispatcher", "administrativo"] },
  { path: "/contracts/:id", component: ContractDetail, roles: ["admin", "dispatcher", "administrativo"] },
