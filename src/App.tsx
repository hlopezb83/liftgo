...
const routes: RouteConfig[] = [
  ...
  { path: "/quotes", component: QuotesPage, roles: ["admin", "dispatcher", "administrativo", "auditor"] },
  { path: "/quotes/new", component: QuoteForm, roles: ["admin", "dispatcher", "administrativo"] },
  { path: "/quotes/:id", component: QuoteDetail, roles: ["admin", "dispatcher", "administrativo", "auditor"] },
