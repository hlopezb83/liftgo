...
import { Settings, Truck, Wrench, FileText, ShieldCheck } from "lucide-react";
...
export default function OperationsSetupPage() {
  return (
    <div className="p-6 max-w-5xl">
      <PageHeader title="Configuración de Operaciones" subtitle="Administrar modelos de equipo, operadores, mecánicos, pólizas y plantillas" />
