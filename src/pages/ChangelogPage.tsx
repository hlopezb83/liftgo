...
import { fetchChangelog, getCurrentVersion, type ChangelogEntry } from "@/lib/changelog";
...
export default function ChangelogPage() {
  ...
  useEffect(() => {
    fetchChangelog().then((data) => { setChangelog(data); setLoading(false); });
  }, []);
  ...
  return (
    <div className="p-6 space-y-6 max-w-3xl mx-auto">
      <PageHeader
        ...
        subtitle={`Versión actual: v${getCurrentVersion(changelog)}`}
      />
