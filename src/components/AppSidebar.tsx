...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Cotizaciones", url: "/quotes", icon: FileText, roles: ["admin", "dispatcher", "administrativo"] },
      { title: "Reservas", url: "/bookings/new", icon: BookOpen, roles: ["admin", "dispatcher", "administrativo"] },
      { title: "Contratos", url: "/contracts", icon: ScrollText, roles: ["admin", "dispatcher", "administrativo"] },
      { title: "Entregas", url: "/deliveries", icon: TruckIcon, roles: ["admin", "dispatcher", "administrativo"] },
      { title: "Devoluciones", url: "/returns", icon: ClipboardCheck, roles: ["admin", "dispatcher", "administrativo"] },
      { title: "Facturas", url: "/invoices", icon: Receipt, roles: ["admin", "dispatcher", "administrativo"] },
    ],
  },
  {
    label: "Flota",
