/**
 * Datos estáticos del catálogo de *bloqueos de negocio explicables*.
 *
 * Este módulo contiene sólo el catálogo y los patrones constantes; la lógica de
 * resolución/formateo vive en `businessBlocks.ts`. Los textos, códigos, regex y
 * el orden son parte del contrato del ERP y no deben alterarse.
 */
...
export type BlockCopy = Omit<BusinessBlock, "code">;
 ...
 */
export const ERROR_PATTERNS: Array<{ pattern: RegExp; code: BusinessBlockCode }> = [
...
export const CONSTRAINT_BLOCKS: Record<string, BusinessBlockCode> = {
 ...
 */
export const FORKLIFT_TARGET_ACTIONS: Record<string, string> = {
