...
/**
 * Excepciones explícitas: operación privilegiada sobre tabla con empresa cuyo
 * alcance no puede expresarse como filtro en la propia consulta. Cada entrada
 * debe decir por qué es segura. Vacía por ahora: no se conoce ninguna.
 */
const ALLOWLIST: { file: string; table: string; reason: string }[] = [];
